...
SECRET_KEY = 'django-insecure-+t-($lp%8e#u!%l&%3^b+(q(0mftn+g&jlv@)#jzd#d&4a!yis'
...
AUTHENTICATION_BACKENDS = [
    'myapp.auth_backends.EmailOrPhoneBackend',   # custom backend
...
# Dev email prints to terminal (for Contact form)
